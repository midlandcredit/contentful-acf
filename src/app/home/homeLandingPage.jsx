...
export default function HomeLandingPage({data}) {
  ...
  return (
    <div className={`pt-[25px] pb-[70px]  px-[30px] laptop:px-[60px] tablet:px-[25px] tablet:mx-[20px]  tablet:pb-[35px] tablet:flex tablet:flex-col tablet:m-auto tablet:relative tablet:h-full tablet:justify-center `}>
